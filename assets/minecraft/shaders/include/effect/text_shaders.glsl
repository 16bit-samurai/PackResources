...
void applyRainbow2(float speed, float scale) {
	text.color.r = 0.33333*(cos((float(gl_VertexID) * 0.01 * scale) + (GameTime * 300 * speed) + 0.00000000000))+0.66666;
    text.color.g = 0.33333*(cos((float(gl_VertexID) * 0.01 * scale) + (GameTime * 300 * speed) + 2.09439510239))+0.66666;
    text.color.b = 0.33333*(cos((float(gl_VertexID) * 0.01 * scale) + (GameTime * 300 * speed) + 4.18879020479))+0.66666;
